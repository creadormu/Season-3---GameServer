...
int APIENTRY WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nCmdShow) // OK
{
	...
	wsprintf(buff,GAMESERVER_VERSION,((gServerInfo->m_ServerType==0)?GAMESERVER_TYPE0:((gServerInfo->m_ServerType==1)?GAMESERVER_TYPE1:"Error")),gServerInfo->m_ServerName);
...
void RenderMenu(HWND hWnd) // OK
{
	...
	AppendMenu(hHelp,MF_STRING,IDM_SSEMU,"MuOnline Web");
...
//FakeOnline_EMU	
				...
				case IDM_ABOUT:
					...
					break;
				case IDM_SSEMU:
					ShellExecute(0,0,"https://www.muonline.com",0,0,SW_SHOW);
					break;
				default:
