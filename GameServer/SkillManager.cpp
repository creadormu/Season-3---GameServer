...
bool CSkillManager::BasicSkillAttackFireSlash(int aIndex, int bIndex, CSkill* lpSkill, bool combo) // OK
{
	LPOBJ lpObj = &gObj[aIndex];
	...
	if(lpObj->Type == OBJECT_USER)
	{
		...
		switch(lpSkill->m_skill)
		{
			...
			case SKILL_IMPALE:
				...
				break;
			case SKILL_FIRE_SLASH:
				this->BasicSkillAttackFireSlash(aIndex, bIndex, lpSkill, combo);
				break;
			case SKILL_FIRE_SCREAM:
				this->BasicSkillAttack(aIndex,bIndex,lpSkill,combo);
				break;
